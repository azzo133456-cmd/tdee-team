...
const STRENGTH_BY_MUSCLE={
  ...
  "腿":["深蹲","前蹲舉","哈克深蹲","史密斯深蹲","腿推","腿伸屈","腿後勾","趴姿腿後勾","羅馬尼亞硬舉","保加利亞分腿蹲","弓步蹲","腿外展機","腿內收機"],
  "臀":["臀推","髖外展機","臀橋","驢踢","繩索側踢","早安運動"],
...
function renderExRecF(){
  ...
  // 已經做到 —— 而她正是最需要被提醒的人。
  const POSTERIOR_LOWER=["硬舉","早安","山羊挺身","臀推","臀橋","驢踢","側踢","髖外展","腿後勾","保加利亞分腿蹲","弓步蹲","登階","分腿蹲","背伸展"];
